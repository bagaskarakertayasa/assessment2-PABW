...
if(isset($_POST['submit'])){
    ...
    $ip	        = $_POST['ip'];					
		...
		$sql = mysqli_query($koneksi, "INSERT INTO ip(semester, ip) VALUES('$semester', '$ip')") or die(mysqli_error($koneksi));
        echo '<script>alert("Selamat, data telah ditambahkan"); document.location="ip.php";</script>';
		}
		?>
...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="ip" class="form-control" placeholder="Masukan IP">
  </div>
